...
<div class="form-group">
    ...
    <div class="col-md-7">
        <label class="radio-inline">
            <input type="radio" name="reverse_direction" {{ !$reverse_direction ? 'checked="checked"' : '' }} value="0" id="reverse_direction"> Normal
        </label>
        <label class="radio-inline">
            <input type="radio" name="reverse_direction" {{ $reverse_direction ? 'checked="checked"' : '' }} value="1"> Reversed
        </label>
    </div>
</div>